        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-10 mb-10">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-2.5">
              <AppLogo size={32} />
              <span className="font-sans text-lg font-800 tracking-tight text-foreground">
          ...
          <div className="flex flex-wrap gap-x-8 gap-y-3">
            {footerData.links.map((link) => (
              <a
                key={link.label}
                href={link.href}
                className="text-sm font-500 text-muted-foreground hover:text-foreground transition-colors duration-200 min-h-[44px] flex items-center"
              >
                {link.label}
              </a>
            ))}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-6">
            <p className="text-xs text-muted-foreground">
              © {new Date().getFullYear()} {footerData.copyright}. All rights reserved.
            </p>
